...
# function below will be called when the user adds a string after /hello/ to the website address. eg /hello/Pius/
...
def hello_with_person_name(name):
    # The two lines below still work. But the second is more convenient as it
...
def hello_with_layout(name):
    return render_template('hello-extended-layout.html', person_name=name)
